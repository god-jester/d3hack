...
macro(__add_binary_library target)
    ...
    foreach(__file ${ARGN})
        ...
        # Generate the header.
        if(EXISTS ${__SWITCH_TOOLS_DIR}/bin2s_header.h.in)
            configure_file(${__SWITCH_TOOLS_DIR}/bin2s_header.h.in ${CMAKE_CURRENT_BINARY_DIR}/bin2s_include/${__BINARY_FILE}.h)
        else()
            configure_file(${CMAKE_SOURCE_DIR}/cmake/bin2s_header.h.in ${CMAKE_CURRENT_BINARY_DIR}/bin2s_include/${__BINARY_FILE}.h)
        endif()
    endforeach()
