...
using unsigned___int128 = unsigned __int128;
...
// It means: while 'p' points to 'char', it also points to the middle of
// 'mystruct'. More precisely, it is at the offset of 8 bytes from the beginning
// of 'mystruct'.
//
